...
# import os
# import time  # <— moved here so it’s always available
# from pathlib import Path
# from datetime import date
...
# # ---------- PAGE + THEME ----------
# st.set_page_config(page_title="She Bets — NBA Bet Sim (MVP)", page_icon="🏀", layout="wide")
...
# # ---------- HEADER ----------
# logo_path = Path("assets/she_bets_logo.svg")
# left, right = st.columns([1, 5])  # removed vertical_alignment for max-compat
# with left:
#     if logo_path.exists():
#         st.image(str(logo_path), use_container_width=True)
#     else:
#         st.markdown("<h2 style='margin:0'>🏀 She Bets</h2>", unsafe_allow_html=True)
# with right:
#     st.markdown(
#         """
#         <div class="headline">
#           <h1>She Bets — NBA Betting Simulator (MVP)</h1>
#           <p class="tagline">Fake bankroll. Real learning.</p>
#         </div>
#         """,
#         unsafe_allow_html=True,
#     )
